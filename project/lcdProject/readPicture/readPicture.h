#ifndef _READPICTURE_H_
#define _READPICTURE_H_
...
//#define PIC_NAME "./my.bmp"
// #define PIC_NAME "./my.200x120.bmp"
#define PIC_NAME1 "./a1.bmp"
#define PIC_NAME2 "./a2.bmp"
